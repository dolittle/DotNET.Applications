...
namespace Dolittle.Events.Handling
{
    ...
    public class EventHandlerMethodMustTakeTwoParameters : InvalidEventHandlerMethodSignature
    {
        ...
        public EventHandlerMethodMustTakeTwoParameters(MethodInfo methodInfo)
            : base(methodInfo, $"The Event Handler '{EventHandlers.HandleMethodName}' methods must take two parameters. {EventHandlers.HandleMethodName}({typeof(IEvent).FullName}, {typeof(EventContext).FullName})")
        {
        }
    }
}