...
{
    public class when_parsing_with_one_recurring_variable_segment : given.a_string_format_parser
    {
        ...
        It should_be_recurring = () => ((VariableStringSegment) format.Segments.First()).Occurrences.ShouldEqual(SegmentOccurrence.Recurring);
    }
}
