...
{
    public class when_parsing_with_one_recurring_fixed_segment : given.a_string_format_parser
    {
        ...
        It should_be_recurring = () => ((FixedStringSegment) format.Segments.First()).Occurrences.ShouldEqual(SegmentOccurrence.Recurring);
    }
}
