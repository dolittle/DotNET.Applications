...
{
    public class when_parsing_with_one_optional_fixed_segment : given.a_string_format_parser
    {
        ...
        It should_be_optional = () => ((FixedStringSegment) format.Segments.First()).Optional.ShouldBeTrue();
    }
}
