...
namespace doLittle.Specs.Domain.for_AggregateRootRepository
{
    ...
    {
        protected static AggregateRootRepository<AggregateRootWithParameterlessConstructor> aggregate_root_repository;
        protected static Exception result;

        Establish context = () => aggregate_root_repository = new AggregateRootRepository<AggregateRootWithParameterlessConstructor>(command_context_manager.Object, event_store.Object, event_source_versions.Object, application_resources.Object, logger.Object);
