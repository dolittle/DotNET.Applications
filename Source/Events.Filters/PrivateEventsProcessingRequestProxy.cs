...
namespace Dolittle.Events.Filters
{
    ...
    /// </summary>
    public class PrivateEventsProcessingRequestProxy : ProcessingRequestProxy<FilterRuntimeToClientRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PrivateEventsProcessingRequestProxy"/> class.
        /// </summary>
        /// <param name="request">The <see cref="FilterRuntimeToClientRequest" />.</param>
        public PrivateEventsProcessingRequestProxy(FilterRuntimeToClientRequest request)
            : base(request)
        {
            Event = request.Event;
