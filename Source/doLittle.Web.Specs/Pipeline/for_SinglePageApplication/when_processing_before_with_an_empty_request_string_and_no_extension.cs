...
{
    public class when_processing_before_with_an_empty_request_string_and_no_extension  : given.a_single_page_application_and_a_web_context_with_default_routes
    {
        Establish context = () => {
