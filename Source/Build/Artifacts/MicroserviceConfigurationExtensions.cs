...
{
    /// <summary>
    /// Extensions for <see cref="MicroserviceTopology"/> that's specific for the Build.Artifact namespace.
    /// </summary>
    public static class MicroserviceConfigurationExtensions
    {
        ...
        /// </summary>
        /// <param name="configuration"><see cref="MicroserviceTopology"/> to extend.</param>
        /// <returns>A map of <see cref="Feature"/> to <see cref="FeatureDefinition"/>.</returns>
        public static IDictionary<Feature, FeatureDefinition> RetrieveFeatures(this MicroserviceTopology configuration)
        {
        ...
        public static Dictionary<Feature, FeatureName> RetrieveAllFeatureIds(this MicroserviceTopology configuration)
        {
        ...
        /// <summary>
        /// Returns a <see cref="FeatureDefinition"/> that matches the artifact with the given namespace based on the <see cref="MicroserviceTopology">MicroserviceConfiguration's </see> topology.
        /// </summary>
        /// <param name="configuration"><see cref="MicroserviceTopology"/> to extend.</param>
        ...
        public static KeyValuePair<Feature, FeatureDefinition> FindMatchingFeature(this MicroserviceTopology configuration, string @namespace)
        {
        ...
        public static KeyValuePair<Feature, FeatureDefinition> FindMatchingFeature(
            this MicroserviceTopology configuration,
            string @namespace,
