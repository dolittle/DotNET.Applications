...
namespace Dolittle.Events.Processing
{
    ...
    public class ProcessMethodEventProcessors : IKnowAboutEventProcessors
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProcessMethodEventProcessors"/> class.
        /// </summary>
        ...
        public void Populate()
        {
            foreach (var processor in _processors)
            {
                ...
                foreach (var method in processor.GetMethods(BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly).Where(m => m.EventProcessorId().Value != Guid.Empty).ToList())
                {
