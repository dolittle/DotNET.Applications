...
{
    public class a_system_for_finding_Commands_and_Events : a_standard_configuration
    {
        ...
        Establish context = () => 
        {
            ...
            the_types.Setup(_ => _.GetEnumerator()).Returns(new List<IArtifactType>(){command_artifact_type, event_artifact_type}.GetEnumerator());
