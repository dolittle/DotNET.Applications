...
namespace Dolittle.Applications.for_ApplicationArtifactIdentifierToTypeMaps
{
    public class when_mapping_with_2_commands_with_same_name_at_different_locations : given.an_application_with_2_commands_with_same_name_in_different_locations
    {
        ...
        Because of = () => 
        {
            ...
            result_identifier_for_SubFeature1Register = aai_to_type_maps.GetIdentifierFor(type_1);
            result_identifier_for_SubFeature2Register = aai_to_type_maps.GetIdentifierFor(type_2);

            result_type_1 = aai_to_type_maps.GetTypeFor(result_identifier_for_SubFeature1Register);
            result_type_2 = aai_to_type_maps.GetTypeFor(result_identifier_for_SubFeature2Register);
            ...
            result_exception = Catch.Exception(() => aai_to_type_maps.GetTypeFor(bad_identifier));
