...
namespace Dolittle.Runtime.Events.Storage.for_EventEnvelopes
{
    public class when_creating_from_an_event_source_two_events_and_version : given.an_event_envelopes
    {
        ...
        static IApplicationArtifactIdentifier event_source_resource_identifier;
        ...
        static IApplicationArtifactIdentifier first_event_resource_identifier;
        static EventSourceVersion first_event_version = new EventSourceVersion(4, 2);

        static Mock<IEvent> second_event;
        static IApplicationArtifactIdentifier second_event_resource_identifier;
