...
namespace doLittle.Specs.Domain.for_AggregateRootRepository
{
    public class when_getting_a_stateless_aggregate_root_with_guid_in_constructor : given.a_command_context
    {
        ...
        Establish context = () => aggregate_root_repository = new AggregateRootRepository<AggregateRootWithGuidConstructor>(command_context_manager.Object, event_store.Object, event_source_versions.Object, application_resources.Object, logger.Object);
