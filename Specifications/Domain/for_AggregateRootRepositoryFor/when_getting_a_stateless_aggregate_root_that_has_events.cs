...
//             event_source_versions.Setup(e => e.GetFor(artifact, event_source_id)).Returns(version_of_last_event);
//         };
...
//         It should_not_get_events_for_the_aggregated_root = () => event_store.Verify(e => e.GetFor(artifact, event_source_id), Moq.Times.Never());
