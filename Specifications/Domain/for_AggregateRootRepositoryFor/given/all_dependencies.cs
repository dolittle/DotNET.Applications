...
namespace Dolittle.Domain.for_AggregateRootRepositoryFor.given
{
    public class all_dependencies
    {
        ...
        protected static Mock<IApplicationArtifactIdentifierToTypeMaps> application_artifacts;
        ...
        Establish context = () =>
        {
            ...
            application_artifacts = new Mock<IApplicationArtifactIdentifierToTypeMaps>();
