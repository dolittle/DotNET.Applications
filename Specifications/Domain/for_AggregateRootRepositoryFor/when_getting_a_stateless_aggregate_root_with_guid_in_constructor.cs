...
namespace Dolittle.Domain.for_AggregateRootRepositoryFor
{
    public class when_getting_a_stateless_aggregate_root_with_guid_in_constructor : given.a_command_context
    {
        ...
        Establish context = () => aggregate_root_repository = new AggregateRootRepositoryFor<AggregateRootWithGuidConstructor>(command_context_manager.Object, event_store.Object, event_source_versions.Object, application_artifacts.Object, logger.Object);
