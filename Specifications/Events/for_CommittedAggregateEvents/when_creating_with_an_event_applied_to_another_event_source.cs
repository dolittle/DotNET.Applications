...
namespace Dolittle.Events.for_CommittedAggregateEvents
{
    public class when_creating_with_an_event_applied_to_another_event_source : given.an_aggregate_instance_and_some_committed_events
    {
        ...
        {
            events = new CommittedAggregateEvents(event_source_id, aggregate_root_type, new CommittedAggregateEvent[] { first_event, second_event, event_with_other_event_source_id });
        });
