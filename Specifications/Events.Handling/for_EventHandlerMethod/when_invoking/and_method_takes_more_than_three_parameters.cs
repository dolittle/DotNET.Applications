...
{
    public class and_method_takes_more_than_three_parameters
    {
        static EventHandlerMethod method;
        static EventHandlerWithMoreThanTwoParameters event_handler;
        static CommittedEvent committed_event;
        static Exception exception;

        Establish context = () =>
        {
            Expression<Action<EventHandlerWithMoreThanTwoParameters>> expression = (EventHandlerWithMoreThanTwoParameters _) => _.Handle(null, null, null);
            method = new EventHandlerMethod(typeof(MyEvent), expression.GetMethodInfo());
            event_handler = new EventHandlerWithMoreThanTwoParameters();
