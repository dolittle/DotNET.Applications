...
namespace Dolittle.Build.Artifact.for_Artifact.for_ArtifactConfigurationBuilder.when_not_using_modules
{
    public class when_building_artifacts_with_an_empty_ArtifactsConfiguration : given.an_empty_ArtifactsConfiguration
    {
        ...
        It should_generate_an_artifacts_configuration_with_one_command_where_the_clr_type_is_correct_under_feature1 = () => result_configuration.Artifacts[feature1].Commands.First().Type.TypeString.ShouldEqual(ClrType.FromType(typeof(Specs.Feature.TheCommand)).TypeString);
        It should_generate_an_artifacts_configuration_with_one_event_where_the_clr_type_is_correct_under_feature1 = () => result_configuration.Artifacts[feature1].Events.First().Type.TypeString.ShouldEqual(ClrType.FromType(typeof(Specs.Feature.TheEvent)).TypeString); 
        It should_generate_an_artifacts_configuration_with_one_query_where_the_clr_type_is_correct_under_feature1 = () => result_configuration.Artifacts[feature1].Queries.First().Type.TypeString.ShouldEqual(ClrType.FromType(typeof(Specs.Feature.TheQuery)).TypeString); 
        It should_generate_an_artifacts_configuration_with_one_read_model_where_the_clr_type_is_correct_under_feature1 = () => result_configuration.Artifacts[feature1].ReadModels.First().Type.TypeString.ShouldEqual(ClrType.FromType(typeof(Specs.Feature.TheReadModel)).TypeString); 
        It should_generate_an_artifacts_configuration_with_one_event_source_where_the_clr_type_is_correct_under_feature1 = () => result_configuration.Artifacts[feature1].EventSources.First().Type.TypeString.ShouldEqual(ClrType.FromType(typeof(Specs.Feature.TheEventSource)).TypeString); 
        ...
        It should_generate_an_artifacts_configuration_with_one_command_where_the_clr_type_is_correct_under_feature2 = () => result_configuration.Artifacts[feature2].Commands.First().Type.TypeString.ShouldEqual(ClrType.FromType(typeof(Specs.Feature3.TheCommand)).TypeString);
        It should_generate_an_artifacts_configuration_with_one_event_where_the_clr_type_is_correct_under_feature2 = () => result_configuration.Artifacts[feature2].Events.First().Type.TypeString.ShouldEqual(ClrType.FromType(typeof(Specs.Feature3.TheEvent)).TypeString); 
        It should_generate_an_artifacts_configuration_with_one_query_where_the_clr_type_is_correct_under_feature2 = () => result_configuration.Artifacts[feature2].Queries.First().Type.TypeString.ShouldEqual(ClrType.FromType(typeof(Specs.Feature3.TheQuery)).TypeString); 
        It should_generate_an_artifacts_configuration_with_one_read_model_where_the_clr_type_is_correct_under_feature2 = () => result_configuration.Artifacts[feature2].ReadModels.First().Type.TypeString.ShouldEqual(ClrType.FromType(typeof(Specs.Feature3.TheReadModel)).TypeString); 
        It should_generate_an_artifacts_configuration_with_one_event_source_where_the_clr_type_is_correct_under_feature2 = () => result_configuration.Artifacts[feature2].EventSources.First().Type.TypeString.ShouldEqual(ClrType.FromType(typeof(Specs.Feature3.TheEventSource)).TypeString); 
