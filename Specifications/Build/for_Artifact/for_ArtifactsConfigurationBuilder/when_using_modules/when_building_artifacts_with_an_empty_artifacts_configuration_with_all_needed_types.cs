...
namespace Dolittle.Build.Artifact.for_Artifact.for_ArtifactConfigurationBuilder.when_using_modules_modules
{
    public class when_building_artifacts_with_an_empty_artifacts_configuration_with_all_needed_types : given.an_empty_artifacts_configuration
    {
        ...
        It should_have_the_first_feature_which_has_one_command_with_the_correct_clr_type = () => result_configuration[first_feature].Commands.First().Type.TypeString.ShouldEqual(ClrType.FromType(typeof(Specs.Module.Feature.TheCommand)).TypeString);
        It should_have_the_first_feature_which_has_one_event_with_the_correct_clr_type = () => result_configuration[first_feature].Events.First().Type.TypeString.ShouldEqual(ClrType.FromType(typeof(Specs.Module.Feature.TheEvent)).TypeString); 
        It should_have_the_first_feature_which_has_one_query_with_the_correct_clr_type = () => result_configuration[first_feature].Queries.First().Type.TypeString.ShouldEqual(ClrType.FromType(typeof(Specs.Module.Feature.TheQuery)).TypeString); 
        It should_have_the_first_feature_which_has_one_read_model_with_the_correct_clr_type = () => result_configuration[first_feature].ReadModels.First().Type.TypeString.ShouldEqual(ClrType.FromType(typeof(Specs.Module.Feature.TheReadModel)).TypeString); 
        It should_have_the_first_feature_which_has_one_event_source_with_the_correct_clr_type = () => result_configuration[first_feature].EventSources.First().Type.TypeString.ShouldEqual(ClrType.FromType(typeof(Specs.Module.Feature.TheEventSource)).TypeString); 
        ...
        It should_have_the_second_feature_which_has_one_command_with_the_correct_clr_type = () => result_configuration[second_feature].Commands.First().Type.TypeString.ShouldEqual(ClrType.FromType(typeof(Specs.Module.Feature3.TheCommand)).TypeString);
        It should_have_the_second_feature_which_has_one_event_with_the_correct_clr_type = () => result_configuration[second_feature].Events.First().Type.TypeString.ShouldEqual(ClrType.FromType(typeof(Specs.Module.Feature3.TheEvent)).TypeString); 
        It should_have_the_second_feature_which_has_one_query_with_the_correct_clr_type = () => result_configuration[second_feature].Queries.First().Type.TypeString.ShouldEqual(ClrType.FromType(typeof(Specs.Module.Feature3.TheQuery)).TypeString); 
        It should_have_the_second_feature_which_has_one_read_model_with_the_correct_clr_type = () => result_configuration[second_feature].ReadModels.First().Type.TypeString.ShouldEqual(ClrType.FromType(typeof(Specs.Module.Feature3.TheReadModel)).TypeString); 
        It should_have_the_second_feature_which_has_one_event_source_with_the_correct_clr_type = () => result_configuration[second_feature].EventSources.First().Type.TypeString.ShouldEqual(ClrType.FromType(typeof(Specs.Module.Feature3.TheEventSource)).TypeString); 
