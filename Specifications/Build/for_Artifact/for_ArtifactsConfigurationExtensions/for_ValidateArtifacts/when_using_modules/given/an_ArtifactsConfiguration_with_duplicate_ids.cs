...
namespace Dolittle.Build.Artifact.for_Artifact.for_ArtifactsConfigurationExtensions.for_ValidateArtifacts.when_using_modules.given
{
    public class an_ArtifactsConfiguration_with_duplicate_ids : given.a_bounded_context_config
    {
        ...
        Establish context = () => 
        {
            ...
            var command_artifact_1 = new ArtifactDefinition(){Artifact = duplicate_id, Generation = ArtifactGeneration.First, Type = ClrType.FromType(typeof(Specs.Module.Feature.TheCommand))};
            ...
            var read_model_artifact_1 = new ArtifactDefinition(){Artifact = duplicate_id, Generation = ArtifactGeneration.First, Type = ClrType.FromType(typeof(Specs.Module.Feature.TheReadModel))};
