...
namespace Dolittle.Build.Topology.for_Topology.for_StringExtensions.for_GetModuleFromPath
{
    public class when_getting_module_from_path_with_module_and_two_features : given.a_module_name
    {
        ...
        It should_should_have_second_feature_definition_with_no_sub_features = () => module_definition.Value.Features.First().Value.SubFeatures.First().Value.SubFeatures.ShouldBeEmpty();
    }
}